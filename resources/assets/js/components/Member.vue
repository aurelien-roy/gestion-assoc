    ...
    <div>
        <div v-if="member">
            <div class="headset relative">
                <h1 class="m0">
                    <EditableText :value="member.firstname" placeholder="Prénom"
                                  class="like-h1 width-auto no-background"
                                  @input="notifyUpdate('firstname', $event)"></EditableText>
                    <EditableText :value="member.lastname" placeholder="Nom"
                                  class="like-h1 thinner width-auto no-background"
                                  @input="notifyUpdate('lastname', $event)"></EditableText>
                </h1>
            </div>
